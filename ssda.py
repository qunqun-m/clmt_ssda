...
parser.add_argument('--ways', type=int, default=25, help='number of classes sampled')
...
parser.add_argument('--save_path', type=str, default='./save_april/BN/exp1',
...
parser.add_argument('--resume', action='store_true', default='result/ssdapa/save_model/temp.log_real_to_sketch_step_90000_alexnet.pth',
...
def train():
    ...
    for step in range(start_step, all_step):
        ...
        if step % args.log_interval == 0 and step > 4000:
